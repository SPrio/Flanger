...
Instrument.create!([{
                   ...
                   },
                    {
                      ...
                      description: 'Hello and thank you for looking at my Item. We are proud to present this stunning \
                      2018 Gibson Les Paul Standard in Bourbon Burst in 100% Mint/Unplayed condition! The 2017 LP \
                      Standards are extremely nice,  with a super comfortable necks, and awesome bold finishes.  \
                      This Bourbon Burst finish is absolutely stunning! The tone that comes out of this monster is \
                      everything you would expect from a Les Paul Standard!! The guitar sounds awesome and has that \
                      famous Les Paul  Tone.  Very easy to play with a nice comfortable standard neck featuring a \
                      compound radius fret board which means shredding speed is easier on a Gibson! This is one great \
                      guitar for the money!  Will  ship via Fed Ex Ground or Home Delivery in Brand New Gibson \
                      case with pictured case candy insured for full purchase price!',
                      condition: 'Used',
                      finish: 'Red',
                      price: '259',
